...
For instructions on how to run the pipeline, see the repository [README](https://github.com/sustentarea/datasus-pop-estimates/blob/main/README.md).
...
- Department of Informatics of the Brazilian Unified Health System ([DATASUS](https://datasus.saude.gov.br/)):
  - Annual population estimates by municipality, age, and sex for Brazil [@datasusb], the primary dataset for this pipeline. See the dataset [technical note](http://tabnet.datasus.gov.br/cgi/IBGE/NT-POPULACAO-RESIDENTE-2000-2024.PDF) (in Portuguese) for details.
...
::: {.callout-note}
The `year` variable represent the year of the consolidated [DATASUS](https://datasus.saude.gov.br/) dataset.
:::
...
## Download DATASUS Population Data
...
```{r}
#| label: Download DATASUS Population Data
...
data <-
  ...
  relocate(region_code:federal_unit) |>
...
### Plot Histogram of Population Estimate by Municipality
...
### Plot Map of Population Estimate by Municipality
